...
var (
	moduleAccPerms = []*authmodulev1.ModuleAccountPermission{
		...
		{Account: warzonemoduletypes.ModuleName, Permissions: []string{authtypes.Minter, authtypes.Burner, authtypes.Staking}}}
	...
	appConfig = appconfig.Compose(&appv1alpha1.Config{
		Modules: []*appv1alpha1.ModuleConfig{
			...
			{
				Name:   warzonemoduletypes.ModuleName,
				Config: appconfig.WrapAny(&warzonemoduletypes.Module{}),
			}},
	})
)
