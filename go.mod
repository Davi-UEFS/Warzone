module github.com/Davi-UEFS/Warzone

go 1.25.10

require (
	github.com/Davi-UEFS/Warzone/warzone-core v0.0.0-00010101000000-000000000000
...
replace github.com/Davi-UEFS/Warzone/warzone-core => ./warzone-core
